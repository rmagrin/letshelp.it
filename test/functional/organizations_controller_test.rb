...
class OrganizationsControllerTest < ActionController::TestCase
  ...
  should "be able to edit organization when match password" do
    xhr :get, :ajax_edit, :format => 'js', :id => organizations(:wwf).id, :password => organizations(:wwf).password
    assert_response :success
  end

  should "not be able to edit organization when password dont match" do
    xhr :get, :ajax_edit, :format => 'js', :id => organizations(:wwf).id, :password => "wrong_pass"
